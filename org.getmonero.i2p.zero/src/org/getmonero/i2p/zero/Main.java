...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("Options set: " + p.entrySet().stream().map(e -> "--" + e.getKey() + "=" + e.getValue()).collect(Collectors.joining(" ")));

		RouterWrapper routerWrapper = new RouterWrapper(p, () -> {
			consoleOut.println("**** A new version of I2P-zero is available at https://github.com/syvita/i2p-zero - Please keep your software up-to-date, as it will enhance your privacy and keep you safe from vulnerabilities");
		});
