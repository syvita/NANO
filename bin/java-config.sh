...
normalizeZip () {
  $JAVA_HOME/bin/java --module-path "$basedir/import/commons-compress-1.20/commons-compress-1.20.jar":"$basedir/target/org.syvita.util.normalizeZip.jar" \
  -m org.syvita.util.normalizeZip 1546300800000 "$1"
}